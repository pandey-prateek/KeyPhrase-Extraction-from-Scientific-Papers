...
class BiLSTMCRF(nn.Module):
    ...
    def save(self, filepath):
        params = {
            ...
            'args': dict(dropout_rate=self.dropout_rate, embed_size=self.embed_size, hidden_size=self.hidden_size, embeds=self.embeds),
...
def train():
    ...
    model = BiLSTMCRF(sent_vocab, tag_vocab, dropout_rate, embed_size, hidden_size, torch.tensor (weights_matrix)).to(device)
